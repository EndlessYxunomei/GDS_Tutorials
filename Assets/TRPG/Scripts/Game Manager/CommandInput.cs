    ...
    public class CommandInput : MonoBehaviour
    {
        ...
        private void MoveCommandInput()
        {
            if (Input.GetMouseButtonDown(0))
            {
                ...
                //лекарстов от всех глюков c поиском пути и анимацией движения
            ...
            if (Input.GetMouseButtonDown(1))
            {
                // selectCharacter.selected.GetComponent<Movement>().ScipAnimation();
                StopCommandInput();
        ...
        public void InitCommand()
        {
            ...
            switch (currentCommand)
            {
                ...
                case CommandType.Attack:
                    {
                        characterAttack.CalculateAttackArea(selectCharacter.selected.GetComponent<GridObject>().positionOnGrid, selectCharacter.selected.GetIntValue(CharacterStats.AttackRange));
                        break;
                    };
            }
        }
